...
from swint.swin_transformer import build_swint_backbone

__all__ = ["build_resnet_fan_backbone", "build_retinanet_resnet_fan_backbone", "FAN"]

from mmcv.ops import DeformConv2dPack as dcn_v2
...
class FeatureAlign_V2(nn.Module):  # FaPN full version
    def __init__(self, in_nc=128, out_nc=128, norm=None):
        ...
        self.dcpack_L2 = dcn_v2(out_nc, out_nc, 3, stride=1, padding=1, dilation=1, deform_groups=8,
...
@BACKBONE_REGISTRY.register()
def build_swinT_fan_backbone(cfg, input_shape: ShapeSpec):
    """
    Args:
        cfg: a detectron2 CfgNode
