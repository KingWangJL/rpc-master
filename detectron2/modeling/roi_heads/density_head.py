...
ROI_HEADS_REGISTRY = Registry("DENSITY_HEADS")
ROI_HEADS_REGISTRY.__doc__ = """
the benchmark of count for collaborative learning
"""
...
class DensityHead(nn.Module):
    ...
    def forward(self, x, detections, targets=None):
        ...
        gt_density_maps = torch.stack([target.get_field('density_map').density_map for target in targets],
                                      dim=0).unsqueeze(1)
